...
import (
	...
	appparams "github.com/enflow.io/enf2/app/params"
	"github.com/enflow.io/enf2/x/enf2"
	enf2keeper "github.com/enflow.io/enf2/x/enf2/keeper"
	enf2types "github.com/enflow.io/enf2/x/enf2/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/enf2d")
	}
...
func New(
	...
	app.enf2Keeper = *enf2keeper.NewKeeper(
        appCodec, keys[enf2types.StoreKey], keys[enf2types.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		enf2.NewAppModule(appCodec, app.enf2Keeper),
